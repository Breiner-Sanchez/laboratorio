...
<head>
    ...
    <title>Análisis Avanzados con Tecnología de IA</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
    ...
    <header class="header fade-in">
        <div class="container">
            <h1 class="display-5 fw-bold">Análisis Avanzados con Tecnología de IA</h1>
            <p class="lead">Integración de Inteligencia Artificial para una detección y precisión diagnóstica avanzada.</p>
    ...
    <section class="content-section text-center fade-in">
        <div class="container">
            <h2>Integración de IA para el Análisis de Imágenes Médicas</h2>
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card p-3">
                        <i class="fas fa-file-medical-alt fa-2x text-primary mb-3"></i>
                        <h5 class="card-title">Envío de Resultados</h5>
                        <p class="card-text">Carga tus resultados de pruebas o estudios médicos en nuestra plataforma segura.  <br>  <br></p>
